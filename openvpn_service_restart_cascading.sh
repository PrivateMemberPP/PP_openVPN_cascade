...
maxhop=1
#
# Timeout-Counter (in Sekunden) zum Verbindungsaufbau (Wert wird je HOP um 5 Sekunden verlaengert)
timeoutcount=8
#
...
function vpn_connect_initial_one {
        ...
        do
                ...
                errorcount=$(echo "$errorcount+0.3" | bc)
        done
...
do
        ...
        do
                ...
                then
                        # 1 Sekunde warten, bevor erneut geprueft wird
                        sleep 1
                        get_cur_tim
                else
